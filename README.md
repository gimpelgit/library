...
<table>
    ...
    <tbody>
        ...
        <tr>
            ...
            <td>INT</td>
            <td>PRIMARY KEY</td>
            <td rowspan="2">Связь с User (MTM)</td>
        </tr>
        <tr>
            <td>name</td>
            <td>VARCHAR(30)</td>
        ...
        <tr>
            <td rowspan="7"><b>Book</b></td>
            <td>id</td>
            <td>INT</td>
            <td>PRIMARY KEY</td>
            <td rowspan="7">Связь с Genre (OTM), Loan (OTM), Reservation (OTM), Author (MTM)</td>
        </tr>
        <tr>
            <td>genre_id</td>
            <td>INT</td>
            <td>FOREIGN KEY REFERENCES Genre(id)</td>
        </tr>
        </tr>
        <tr>
            <td>author_id</td>
            <td>INT</td>
            <td>FOREIGN KEY REFERENCES Author(id)</td>
        </tr>
        <tr>
            <td>title</td>
            <td>VARCHAR(100)</td>
        ...
        <tr>
            ...
            <td>INT</td>
            <td>PRIMARY KEY</td>
            <td rowspan="2">Связь с Book (OTM)</td>
        </tr>
        <tr>
            <td>name</td>
            <td>VARCHAR(50)</td>
        ...
        <tr>
            <td rowspan="5"><b>BookSuggestion</b></td>
            <td>id</td>
            <td>INT</td>
            <td>PRIMARY KEY</td>
            <td rowspan="5">Связь с User (OTM)</td>
        </tr>
        <tr>
            <td>user_id</td>
            <td>INT</td>
        ...
        <tr>
            <td rowspan="5"><b>ReadingList</b></td>
            <td>id</td>
            <td>INT</td>
            <td>PRIMARY KEY</td>
            <td rowspan="5">Связь с User (OTM), Book (MTM)</td>
        </tr>
        <tr>
            <td>user_id</td>
            <td>INT</td>
